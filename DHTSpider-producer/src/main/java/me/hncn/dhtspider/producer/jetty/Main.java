package me.hncn.dhtspider.producer.jetty;
...
public class Main {
    ...
    private WebAppContext getWebAppContext(URI baseUri, File scratchDir) {
        ...
        String classpath = baseUri.toASCIIString();
        String webxmlPath = classpath.substring(0, classpath.lastIndexOf("classes")) + "web.xml";
        String resourcePath = classpath.substring(0, classpath.lastIndexOf("/WEB-INF"));
